...
public class Decentswerve extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        AnalogInput BLE = hardwareMap.get(AnalogInput.class, "rear_left_enc");
        BRE = hardwareMap.get(AnalogInput.class, "rear_right_enc");
        FLE = hardwareMap.get(AnalogInput.class, "front_left_enc");
        FRE = hardwareMap.get(AnalogInput.class, "front_left_enc");

        BLD = hardwareMap.get(DcMotorEx.class, "rear_left_drive");
        BRD = hardwareMap.get(DcMotorEx.class, "rear_right_drive");
        FLD = hardwareMap.get(DcMotorEx.class, "front_left_drive");
        FRD = hardwareMap.get(DcMotorEx.class, "front_right_drive");

        BLT = hardwareMap.get(CRServo.class, "rear_left_turn");
        BRT = hardwareMap.get(CRServo.class, "rear_right_turn");
        FLT = hardwareMap.get(CRServo.class, "front_left_turn");
        FRT = hardwareMap.get(CRServo.class, "front_right_turn");
